...
if not _RELEASE:
    ...
    _component_func = components.declare_component("streamlit_plotly_chart_events", path=build_dir)
...
def plotly_chart_events(plot_fig,
    click_event=False,
    select_event=False,
    hover_event=False,
    override_height=500,
...
if not _RELEASE:
    ...
    clickedPoint = plotly_chart_events(fig, click_event=True, key="line")
